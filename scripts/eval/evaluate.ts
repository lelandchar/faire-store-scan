...
const VARIANTS: Record<string, Variant> = {
  ...
  gemini: { ...base, name: "gemini", encoder: "gemini", scoring: DEFAULT_SCORING_OPTIONS, prompts: "app", fusion: { tag: 0.4, visual: 0, semantic: 0, nn: 0.45, centroid: 0.15 }, tagWeights: { style: 0.08, category: 0.6 }, nn: { imageShare: 0.8 } },
  geminimix: { ...base, name: "geminimix", encoder: "gemini", scoring: DEFAULT_SCORING_OPTIONS, prompts: "app", fusion: { tag: 0.4, visual: 0, semantic: 0, nn: 0.45, centroid: 0.15 }, tagWeights: { style: 0.08, category: 0.6 }, nn: { imageShare: 0.6 } },
